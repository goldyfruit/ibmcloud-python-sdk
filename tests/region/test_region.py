...
class RegionTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fake_region['default_security_group'] = 'fruit-average-shaping-gone-denture-rumor'
        self.fake_region['default_network_acl'] = 'unpainted-crucial-trimmer-perennial-zipfile-barcode'
    ...
    def test_get_region_with_name(self):
        ...
        print(response)
        self.assertEqual(response['regions'][0]['name'], self.fake_region['name'])
...
#        response = self.region.get_region_default_security_group(self.fake_region['id'])
#        print(response)
#        self.assertEqual(response['default_security_group']['name'], self.fake_region['default_security_group'])
#
#    @patch('ibmcloud_python_sdk.vpc.region.qw', common.fake_get_one)
#    def test_get_region_default_network_acl(self):
#        """Test get_region_default_network_acl."""
#        response = self.region.get_region_default_network_acl(self.fake_region['id'])
#        self.assertEqual(response['default_network_acl']['name'], self.fake_region['default_network_acl'])
#
